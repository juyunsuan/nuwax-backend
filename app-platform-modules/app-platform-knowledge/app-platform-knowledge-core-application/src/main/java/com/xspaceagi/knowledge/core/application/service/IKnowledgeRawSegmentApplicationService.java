...
public interface IKnowledgeRawSegmentApplicationService {
     ...
     * @return
     */
    List<KnowledgeRawSegmentModel> queryListForPendingQaAndGenerateQa(Integer days, Integer pageSize, Integer pageNum);
