...
@Slf4j
@Component
public class EcoMarketClientConfigTranslator implements IEcoMarketClientConfigTranslator {
    @Override
    public EcoMarketClientConfigModel convertToModel(EcoMarketClientConfig entity) {
        if (entity == null) {
            return null;
        }
    ...
    @Override
    public EcoMarketClientConfig convertToEntity(EcoMarketClientConfigModel model) {
        if (model == null) {
            return null;
        }

        return EcoMarketClientConfig.builder()
                .id(model.getId())
                .uid(model.getUid())
                .name(model.getName())
